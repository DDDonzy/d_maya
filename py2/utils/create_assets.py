...
def create_assets(name, **kwargs):
    ...
    cmds.setAttr("{}.blackBox".format(assets), black_box)
    if icon:
        cmds.setAttr("{0}.iconName".format(assets), icon, type="string")
