...
def install_hotkey():
    hotkeyFile = (Path(__file__).parent / "d_hotkey.mhk")
    hotkeyName = hotkeyFile.stem

    if cmds.hotkeySet(hotkeyName,q=1,ex=1):
        cmds.hotkeySet(hotkeyName,e=1,delete=1)
    cmds.hotkeySet(e=1, ip=hotkeyFile)
