...
weapon = ["sword_00", "sword_01", "sword_02", "sword_03", "sword_04"]


anim_bones = _anim_bones + additional_bones
body_bones = _meta_human_body_bones + additional_bones

cmds.sets(anim_bones, name="Export_ANI_Body")
cmds.sets(weapon, name="Export_ANI_Weapon")


export_set = []
for x in cmds.ls(type="objectSet"):
    if x.startswith("Export_"):
        export_set.append(x)

cmds.sets(export_set, name="Export_Set")
